...
- Paid ebook/product uploads go into the private `product-files` bucket and can be PDF, Word, Excel, zip, or another downloadable file type. Public images go into the `cms-assets` bucket.
