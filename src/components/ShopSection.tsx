        ...
        {selectedPlan && (
          <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/75 p-3 backdrop-blur-md sm:items-center sm:p-6">
            ...
            <motion.div
              ...
              exit={{ opacity: 0, scale: 0.96, y: 15 }}
              transition={{ duration: 0.25 }}
              className="relative z-10 max-h-[calc(100dvh-1.5rem)] w-full max-w-4xl space-y-6 overflow-y-auto rounded-2xl border border-[#12141a]/15 bg-[#ffffff] p-6 text-[#12141a] shadow-2xl no-scrollbar sm:max-h-[90vh] sm:p-8"
            >
              {/* Header */}
              <div className="sticky top-0 z-20 -mx-6 -mt-6 flex items-center justify-between border-b border-[#12141a]/10 bg-white/95 px-6 pb-4 pt-6 backdrop-blur sm:-mx-8 sm:-mt-8 sm:px-8 sm:pt-8">
                <div className="flex items-center gap-2">
              ...
              <div className="relative aspect-[16/9] rounded-xl overflow-hidden bg-[#0e1015] border border-[#12141a]/15">
                <img
                  ...
                  className="w-full h-full object-contain filter blur-[2px] opacity-40 scale-105"
                />
