...
const getProductDetails = (product: any) => {
  ...
  return {
    ...
    description: product.description || product.tagline || product.subtitle,
  };
};
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid items-start gap-4 lg:grid-cols-[1fr_1fr]">
          <section className="rounded-2xl border border-[#12141a]/10 bg-white p-4 shadow-sm sm:p-5">
            ...
            {productDetails.image && <div className="mb-3 aspect-[16/10] overflow-hidden rounded-xl border border-[#12141a]/10 bg-[#ebe7df]"><img src={productDetails.image} alt={productDetails.title} className="h-full w-full object-contain" /></div>}
